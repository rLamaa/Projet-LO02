...
/**
 * Joueur humain qui peut jouer via l'interface graphique ou la console
 * Utilise CountDownLatch pour synchroniser les threads GUI et jeu et ne pas bloquer les envois
 */
public class JoueurHumainGUI extends JoueurHumain {
    ...
    /**
     * Fait une offre : attend l'input de la GUI si activée, sinon utilise la console
     */
    @Override
    ...
    /**
     * Choisit une carte : attend l'input de la GUI si activée, sinon utilise la console
     */
    @Override
